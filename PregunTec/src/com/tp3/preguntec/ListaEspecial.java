...
public class ListaEspecial 
{
	...
	public void InsertaInicio(String usr_p,String pregunta,int id,Lista tags)
	{
		//Lista Vacía
		if (Vacialista())
		{
	...
	public void InsertaFinal(String usr_p, String pregunta,int id,Lista tags)
	{
		//Lista Vacía
		if (Vacialista()){
			PrimerNodo = new Nodoespecial (usr_p,pregunta,id,tags);
	...
	public void InsertaMedio(String usr_p,String pregunta,int id,Lista tags, int Posicion )
	{
		//Lista Vacía
		if (Vacialista())
		{
