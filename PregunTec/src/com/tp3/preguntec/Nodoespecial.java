...
Nodoespecial (String usr_p,String pregunta_usr,int id_p,Lista L_tags){
	noob=usr_p;
...
Nodoespecial (String usr_p,String pregunta_usr,int id_p,Lista L_tags, Nodoespecial signodo){
	noob=usr_p;
	pregunta= pregunta_usr;
	id=id_p;
	tags= L_tags;
